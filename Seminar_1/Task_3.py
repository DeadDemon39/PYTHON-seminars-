...
# можно также рашитть через библиотеку math (math.ceil)
print(f"Наименьшее число парт, которое нужно приобрести = {result + (result % 2 != 0)}шт.")


result = (a + 1) // 2 + (b + 1) // 2 + (c + 1) // 2
print(f"Наименьшее кол-во парт: ", result)  # Ответ преподавателя
